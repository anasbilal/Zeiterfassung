...
import com.iadvise.daoImpl.FirmaDao;
...
public class FirmaResource {
	 ...
	 * 
	 * @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	 * public List<Firma> findByName(@PathParam("query") String query) {
	...
	@Path("{id}")
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Firma findById(@PathParam("id") String id) {
	...
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Firma create(Firma Firma) throws Exception {
		System.out.println("creating Firma");
		return dao.add(Firma);
	}
	...
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Firma update(Firma Firma) throws Exception {
		System.out.println("Updating Firma: " + Firma.getFirmaid());
		dao.edit(Firma);
		return Firma;
	}
