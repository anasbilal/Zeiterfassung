...
import com.iadvise.daoImpl.BrancheDao;
...
public class BrancheResource {
	 ...
	 * 
	 * @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	 * public List<Branche> findByName(@PathParam("query") String query) {
	...
	@Path("{id}")
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Branche findById(@PathParam("id") String id) {
	...
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Branche create(Branche Branche) throws Exception {
		System.out.println("creating Branche");
		return dao.add(Branche);
	}
	...
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Branche update(Branche Branche) throws Exception {
		System.out.println("Updating Branche: " + Branche.getBeschreibung());
		dao.edit(Branche);
		return Branche;
	}
